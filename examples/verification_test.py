...
# Setup source GP with multiple hyper-parameter
myK2 = Noise([0.1]) + SquareExp([1., .7])
myHyper2 = [[False], [True, Gamma(1.,2.)]]
...
# Setup the GPR object
myGPR2 = GPR(Xd1, shift(Yd1), myK2)

## Posterior of the hyper-parameter
#hyper = linspace(0.1, 2.0, 100)
...
(Yi2, Yi2std) = (shift.reverse(Yi2).reshape(-1), Yi2std.reshape(-1))
