...
#from pyregress.kernels import Noise, SquareExp, RatQuad
from pyregress import Probit
plt.close('all')
...
myGPR1 = GPR(Xd1, Yd1, myK1, explicit_basis=[0, 1])
...
# Setup the GPR object
myGPR2 = GPR(Xd1, Yd1, myK2, explicit_basis=[0, 1])

## Posterior of the hyper-parameter
hyper = linspace(0.1, 50.0, 100)
